...
class Sorabh extends StatefulWidget {
  @override
  _SorabhState createState() => _SorabhState();
}

class _SorabhState extends State<Sorabh> {
  TabController tabController;
  String dropdownValue = 'SORABH';
  @override
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        width: 350,
                        child: Text(
                          "HEY GUYS! WE HAVE EXCITING NEWS. NEW EPISODE OF WAKING UP WITH SORABH WILL BE STREAMING SOON. SUCH AN EXCITING GUEST LINE UP I AM LOOKING FORWARD TO SHARING THIS EXCLUSIVELY WITH YOU GUYS CHEERS!",
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        width: 350,
                        child: Text(
                          "WHAT ARE YOUR PREDICTIONS FOR THIS YEAR'S IPL? I HAVE A FEELING THAT MUMBAL INDIANS IS NOT GOING TO DO WELL.\n\nMAYBE RCB CAN FLIP ALL THEIR BAD LUCK AND GIVE A TOUGH FIGHT FOR THE TITLE. HAVE SOME EXPECTATIONS FROM SRI AS WELL.KKR TEAM IS DEFINITELY THE DARKS HORSE (PUN INTENDED. THEY HAVE ENDUGH FIREPOWER WITH GILL & RUSSEL MORGAN IS A GOOD LEADER. LETS HOPE THEY DO BETTER THAN LAST YEAR.",
                          style: TextStyle(color: Colors.white, fontSize: 13),
                        ),
                      ),
                      SizedBox(
