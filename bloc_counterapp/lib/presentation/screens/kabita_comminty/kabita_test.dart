...
class Kabita extends StatefulWidget {
  @override
  _KabitaState createState() => _KabitaState();
}

class _KabitaState extends State<Kabita> {
  TabController tabController;
  FirebaseFirestore firestore = FirebaseFirestore.instance;
  String dropdownValue = 'KABITA';
  @override
