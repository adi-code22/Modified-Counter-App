...
class Vaibhav extends StatefulWidget {
  @override
  _VaibhavState createState() => _VaibhavState();
}

class _VaibhavState extends State<Vaibhav> {
  TabController tabController;
  String dropdownValue = 'VAIBHAV';
  @override
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        width: 350,
                        child: Text(
                          "HI EVERYONE,JUST A TWO PIECE TIP TO ALL THOSE WORRYING OUT FOR LINKED IN PREMIUM YOU CAN GET ONE FOR FREE JUST SEARCH #LINKEDINPREMIUM AND SEARCH, LOT OF MARKETEERS GIVE IT FREE AND HAVE POSTED LINK TO SUBSCRIBE! I HAVE BEEN USING LINKEDIN PREMIUM FOR FREE FROM QUITE SOME TIME NOW!",
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        width: 350,
                        child: Text(
                          "FOR ME, DRAFTING CONTENT WAS REALLY A TOUGH TASK. BUT AFTER ATTENDING VAIBHAV SISINTY WORKSHOP, CAN OBSERVE A LOT OF POSITIVE CHANGES IN THE CONTENT I WRITEN\nAS I HAVE STARTED DOING A LOT OF RESEARCH AND AS A RESULT, I AM LEARNING SOME USEFUL STUFF. ALSO, I HAVE OBSERVED SOME GOOD ACTIVITIES ON MY LINKEDIN PROFILE WHICH IS VERY HELPFUL FOR MY BUSINESS. THANK YOU. VAIBHAY FOR ALL YOUR EFFORTS.",
                          style: TextStyle(color: Colors.white, fontSize: 13),
                        ),
                      ),
                      SizedBox(
